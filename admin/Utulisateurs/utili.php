  ...
  <div class="layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-item active" onclick="location.href='../Utulisateurs/utili.html'">
          <span class="nav-icon">👥</span>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td><span class="badge badge-soft">Stagiaire</span></td>
                  <td>DEV 101</td>
                  <td><span class="status status-success">Actif</span></td>
                  <td>15/01/2026</td>
                  <td class="actions-cell">
                    <div class="actions-cell-inner">
                      <button class="btn btn-secondary">accepter</button>
                ...
                <tr>
                  <td class="user-cell">
                    <div class="user-cell-inner">
                      <span class="user-avatar">Pr</span>
                      <div>
                        <strong>Prof. Kamal Benjelloun</strong>
                      </div>
                    </div>
                  </td>
                  <td>k.benjelloun@ismo.ma</td>
                  <td><span class="badge badge-soft">Formateur</span></td>
                  <td>DEV</td>
                  <td><span class="status status-success">Actif</span></td>
                  <td>01/09/2025</td>
                  <td class="actions-cell">

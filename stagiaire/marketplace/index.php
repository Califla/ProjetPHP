...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['pub'])) {
  ...
  if (empty($err)) {
    ...
    try {
      ...
      if ($stmt == true) {
        header("Location: index.php?msg=demande+publi%C3%A9e+avec+succ%C3%A8s");
        exit();
      } else {
        header("Location: index.php?error=Erreur+ Lors+de+la+publication");
        exit();
      }
...
<head>
  ...
  <title>ISMO-SkillSwap – Marketplace</title>
...
<body>
  <div class="layout">
    ...
    <main class="main" data-role="<?php echo $role; ?>">
      ...
      <div class="page-header">
        <div>
          ...
          <div class="page-sub">Trouvez des demandes auxquelles vous pouvez répondre ou publiez la vôtre</div>
        </div>
      ...
      <div class="demandes-list">
        ...
        if (count($demandes) == 0): ?>
          <div class="empty-state">Aucune demande d'aide disponible pour le moment.</div>
        <?php endif; ?>
